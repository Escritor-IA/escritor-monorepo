...
export function ResourceNotFound({
  eyebrow = "ERRO 404 · NÃO ENCONTRADO",
  title = "Esta página",
  titleEm = "nunca foi escrita.",
  description = "O recurso que você buscou não existe ou foi removido.",
  backLabel = "← Voltar ao dashboard",
  backTo = "/dashboard",
  cardLabel = "FOLHA Nº 404",
      ...
      <main style={{
        ...
        <div>
          ...
          <h1 className="serif" style={{
            ...
            {title}<br />
            <em style={{ color: "var(--ink-3)" }}>{titleEm}</em>
          </h1>
          ...
          <div style={{ marginTop: 30 }}>
            <Button variant="primary" size="lg" onClick={() => navigate(backTo)}>
              {backLabel}
            </Button>
          </div>
        ...
        <div style={{
          ...
          <div className="card" style={{
            ...
            <div className="eyebrow" style={{ fontSize: 10 }}>MANUSCRITO · {cardLabel}</div>
