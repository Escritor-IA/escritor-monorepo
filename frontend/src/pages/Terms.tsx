...
const TERMS_STYLES = `
.terms-doc{scroll-behavior:smooth}
.terms-doc .shell{max-width:820px;margin:0 auto;padding:0 24px 96px;position:relative;z-index:1}
.terms-doc header.masthead{padding:64px 0 36px;border-bottom:1px solid var(--card-edge);margin-bottom:36px}
.terms-doc .eyebrow{display:inline-flex;align-items:center;gap:10px;font-family:var(--sans);font-size:11px;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-3);margin:0 0 16px;font-weight:500}
.terms-doc .eyebrow::before{content:"";width:24px;height:1px;background:var(--ink-4);display:inline-block}
.terms-doc .logo{display:inline-flex;align-items:baseline;gap:5px;font-family:var(--serif);font-size:22px;font-weight:500;letter-spacing:-.01em;color:var(--ink);margin-bottom:22px}
.terms-doc .logo .dot{color:var(--green);font-style:italic}
.terms-doc h1{font-family:var(--serif);font-size:42px;line-height:1.1;margin:0 0 16px;color:var(--ink);font-weight:500;letter-spacing:-.02em}
.terms-doc .dek{font-size:15.5px;color:var(--ink-3);max-width:60ch;margin:0}
.terms-doc .meta-row{display:flex;gap:24px;flex-wrap:wrap;margin-top:26px;font-size:13px;color:var(--ink-3)}
.terms-doc .meta-row span strong{color:var(--ink);font-weight:600}
.terms-doc nav.toc{background:var(--card);border:1px solid var(--card-edge);border-radius:14px;padding:24px 28px;margin-bottom:56px;box-shadow:var(--sh-1)}
.terms-doc nav.toc h2{font-family:var(--sans);font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--ink-3);margin:0 0 14px;font-weight:600}
...
.terms-doc nav.toc a{color:var(--ink-2);text-decoration:none;border-bottom:1px solid transparent;transition:border-color .15s ease,color .15s ease}
.terms-doc nav.toc a:hover,.terms-doc nav.toc a:focus-visible{border-bottom-color:var(--green);color:var(--ink)}
.terms-doc .part-label{font-family:var(--sans);font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:var(--green);font-weight:600;margin:64px 0 8px;display:flex;align-items:center;gap:10px}
.terms-doc .part-label::after{content:"";flex:1;height:1px;background:var(--card-edge)}
.terms-doc h2{font-family:var(--serif);font-size:27px;font-weight:500;color:var(--ink);margin:0 0 20px;padding-bottom:14px;border-bottom:1px solid var(--card-edge);letter-spacing:-.01em}
.terms-doc h3{font-family:var(--serif);font-size:18px;font-weight:600;color:var(--ink);margin:28px 0 10px}
.terms-doc p{margin:0 0 16px;color:var(--ink-2)}
.terms-doc ul,.terms-doc ol.clauses{margin:0 0 16px;padding-left:22px;color:var(--ink-2)}
.terms-doc li{margin-bottom:8px}
.terms-doc strong{color:var(--ink);font-weight:600}
.terms-doc .callout{background:linear-gradient(180deg,var(--mint-wash),transparent);border-left:3px solid var(--green);padding:16px 20px;border-radius:0 10px 10px 0;margin:20px 0;font-size:15px}
.terms-doc .callout p:last-child{margin-bottom:0}
.terms-doc .callout.warn{border-left-color:var(--red);background:linear-gradient(180deg,var(--red-wash),transparent)}
.terms-doc table{width:100%;border-collapse:collapse;margin:20px 0;font-size:14px}
.terms-doc th,.terms-doc td{text-align:left;padding:10px 12px;border-bottom:1px solid var(--card-edge);vertical-align:top}
.terms-doc th{font-size:11px;letter-spacing:.06em;text-transform:uppercase;color:var(--ink-3);font-weight:600}
.terms-doc td{color:var(--ink-2)}
.terms-doc code{background:var(--paper-2);padding:2px 6px;border-radius:4px;font-size:.9em;font-family:var(--mono);color:var(--ink)}
.terms-doc .anchor-offset{scroll-margin-top:24px}
.terms-doc footer.doc-footer{margin-top:72px;padding-top:24px;border-top:1px solid var(--card-edge);font-size:13px;color:var(--ink-4)}
.terms-doc .back-to-top{display:inline-block;margin-top:40px;font-size:13px;color:var(--green);text-decoration:none;border-bottom:1px solid var(--card-edge)}
.terms-doc .back-to-top:hover{border-bottom-color:var(--green)}
...
export function Terms() {
  ...
  return (
    <div className="terms-doc" style={{ minHeight: "100vh", background: "var(--paper)" }}>
